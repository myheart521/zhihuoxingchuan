...
function kf(e) {
  throw new Error("https://example.invalid/resource");
}
function $f() {
  throw new Error("https://example.invalid/resource");
}
...
function Ni(e) {
  console.warn("https://example.invalid/resource");
}
let Pe = !1;
function It(e) {
  Pe = e;
...
const Dr = {
  error001: () => "[React Flow]: Seems like you have not used zustand provider as an ancestor. Help: https://example.invalid/resource",
...
var Z2 = /* @__PURE__ */ ne('<a href="https://example.invalid/resource" target="_blank" rel="noopener noreferrer" aria-label="Svelte Flow attribution">Svelte Flow</a>');
function Xc(e, t) {
  de(t, !1);
  ...
  var o = et(), i = be(o);
  {
    var s = (a) => {
      Ho(a, {
        ...
        "data-message": "Feel free to remove the attribution or check out how you could support us: https://example.invalid/resource",
        children: (l, u) => {
          var c = Z2();
          L(l, c);
        },
