package com.example.project.module.ai.framework.ai.core;
...
import com.example.project.module.ai.framework.ai.config.AiAutoConfiguration;
import com.example.project.module.ai.framework.ai.config.ProjectAiProperties;
...
import com.example.project.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.example.project.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            ProjectAiProperties.MidjourneyProperties properties = SpringUtil.getBean(ProjectAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#deepSeekChatModel(ProjectAiProperties)}
     */
    private static DeepSeekChatModel buildDeepSeekChatModel(String apiKey) {
        ProjectAiProperties.DeepSeekProperties properties = new ProjectAiProperties.DeepSeekProperties()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDeepSeekChatModel(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(ProjectAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        ProjectAiProperties.DouBaoProperties properties = new ProjectAiProperties.DouBaoProperties()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(ProjectAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        ProjectAiProperties.HunYuanProperties properties = new ProjectAiProperties.HunYuanProperties()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(ProjectAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        ProjectAiProperties.SiliconFlowProperties properties = new ProjectAiProperties.SiliconFlowProperties()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(ProjectAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        ProjectAiProperties.XingHuoProperties properties = new ProjectAiProperties.XingHuoProperties()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(ProjectAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        ProjectAiProperties.BaiChuanProperties properties = new ProjectAiProperties.BaiChuanProperties()
                .setApiKey(apiKey);
    ...
    private RedisVectorStore buildRedisVectorStore(EmbeddingModel embeddingModel,
        ...
        JedisPooled jedisPooled = new JedisPooled(redisProperties.getHost(), redisProperties.getPort(),redisProperties.getUsername(),redisProperties.getPassword());
