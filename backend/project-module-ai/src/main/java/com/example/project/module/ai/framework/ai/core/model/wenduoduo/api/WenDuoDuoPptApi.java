package com.example.project.module.ai.framework.ai.core.model.wenduoduo.api;
 ...
 * @see <a href="https://example.invalid/resource">PPT 生成 API</a>
 */
@Slf4j
public class WenDuoDuoPptApi {
     ...
     * @param files   文件列表
     * @return 任务 ID
     * @see <a href="https://example.invalid/resource">创建任务</a>
     */
