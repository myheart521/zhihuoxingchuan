package com.example.project.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.example.project.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
