package com.example.project.module.infra.service.codegen.inner;
...
import com.example.project.framework.common.util.date.LocalDateTimeUtils;
...
import com.example.project.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String mapperXmlFilePath() {
        return "project-module-${table.moduleName}/" + // 顶级模块
                "project-module-${table.moduleName}-biz/" + // 子模块
