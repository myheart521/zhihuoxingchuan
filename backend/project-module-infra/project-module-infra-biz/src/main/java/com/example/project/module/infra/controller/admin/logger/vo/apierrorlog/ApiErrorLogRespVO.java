package com.example.project.module.infra.controller.admin.logger.vo.apierrorlog;
...
import com.example.project.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(com.example.project.module.system.enums.DictTypeConstants.USER_TYPE)
