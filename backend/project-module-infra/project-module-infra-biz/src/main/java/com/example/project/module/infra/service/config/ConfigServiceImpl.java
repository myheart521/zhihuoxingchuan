package com.example.project.module.infra.service.config;

import com.example.project.framework.common.pojo.PageResult;
import com.example.project.module.infra.controller.admin.config.vo.ConfigPageReqVO;
import com.example.project.module.infra.controller.admin.config.vo.ConfigSaveReqVO;
import com.example.project.module.infra.convert.config.ConfigConvert;
import com.example.project.module.infra.dal.dataobject.config.ConfigDO;
import com.example.project.module.infra.dal.mysql.config.ConfigMapper;
import com.example.project.module.infra.enums.config.ConfigTypeEnum;
