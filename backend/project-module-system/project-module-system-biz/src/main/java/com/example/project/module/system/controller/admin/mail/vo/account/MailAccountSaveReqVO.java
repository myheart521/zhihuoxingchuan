package com.example.project.module.system.controller.admin.mail.vo.account;
...
public class MailAccountSaveReqVO {
    ...
    @Schema(description = "邮箱", requiredMode = Schema.RequiredMode.REQUIRED, example = "maintainer@example.invalid")
