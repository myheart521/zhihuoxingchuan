package com.example.project.module.system.controller.admin.dept.vo.dept;
...
public class DeptSaveReqVO {
    ...
    @Schema(description = "联系电话", example = "00000000000")
    @Size(max = 11, message = "联系电话长度不能超过11个字符")
    private String phone;

    @Schema(description = "邮箱", example = "maintainer@example.invalid")
