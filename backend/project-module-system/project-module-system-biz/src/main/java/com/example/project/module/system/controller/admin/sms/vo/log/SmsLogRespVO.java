package com.example.project.module.system.controller.admin.sms.vo.log;
...
import com.example.project.framework.excel.core.convert.JsonConvert;
...
public class SmsLogRespVO {
    ...
    @Schema(description = "手机号", requiredMode = Schema.RequiredMode.REQUIRED, example = "00000000000")
    @ExcelProperty("手机号")
