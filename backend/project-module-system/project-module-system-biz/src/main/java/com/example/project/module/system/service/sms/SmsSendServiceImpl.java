package com.example.project.module.system.service.sms;
...
import com.example.project.module.system.framework.sms.core.client.SmsClient;
...
import com.example.project.module.system.dal.dataobject.sms.SmsChannelDO;
import com.example.project.module.system.dal.dataobject.sms.SmsTemplateDO;
import com.example.project.module.system.dal.dataobject.user.AdminUserDO;
import com.example.project.module.system.mq.message.sms.SmsSendMessage;
import com.example.project.module.system.mq.producer.sms.SmsProducer;
...
public class SmsSendServiceImpl implements SmsSendService {
     ...
     * <p>
     * 原因是，部分短信平台并不是使用 key 作为参数，而是数组下标，例如说 <a href="https://example.invalid/resource">腾讯云</a>
     *
     * @param template       短信模板
