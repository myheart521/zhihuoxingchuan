...
public interface AdminUserService {
    ...
    void updateUserAuthority(UserUpdateAuthorityReqVO reqVO);

    PageResult<UserManageRespVO> getUserManagePage(UserManageReqVO pageReqVO);

    /**
     * 修改用户的权限
     * @param reqVO
     */
    void updateUserManage(UserUpdateManageReqVO reqVO);
     ...
     * @param reqVO
     */
    void updateUserInfo(UserUpdateInfoReqVO reqVO);
     ...
     * @return 分页列表
     */
    PageResult<AdminUserDO> getUserAuthorityPage(UserAuthorityReqVO pageReqVO);
