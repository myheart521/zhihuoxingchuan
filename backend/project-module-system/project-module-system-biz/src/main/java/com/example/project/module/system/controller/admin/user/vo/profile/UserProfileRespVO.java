package com.example.project.module.system.controller.admin.user.vo.profile;
...
public class UserProfileRespVO {
    ...
    @Schema(description = "最后登录 IP", requiredMode = Schema.RequiredMode.REQUIRED, example = "127.0.0.1")
