...
import com.example.project.module.system.framework.sms.core.enums.SmsChannelEnum;
import com.example.project.module.system.service.sms.SmsSendService;
...
public class SmsCallbackController {
    ...
    @PostMapping("/aliyun")
    @PermitAll
    @Operation(summary = "阿里云短信的回调", description = "参见 https://example.invalid/resource 文档")
    ...
    @PostMapping("/tencent")
    @PermitAll
    @Operation(summary = "腾讯云短信的回调", description = "参见 https://example.invalid/resource 文档")
    ...
    @PostMapping("/huawei")
    @PermitAll
    @Operation(summary = "华为云短信的回调", description = "参见 https://example.invalid/resource 文档")
    ...
    @PostMapping("/qiniu")
    @PermitAll
    @Operation(summary = "七牛云短信的回调", description = "参见 https://example.invalid/resource 文档")
