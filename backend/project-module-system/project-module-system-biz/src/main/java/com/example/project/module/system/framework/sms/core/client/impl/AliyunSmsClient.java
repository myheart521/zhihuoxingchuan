package com.example.project.module.system.framework.sms.core.client.impl;
...
import com.example.project.framework.common.core.KeyValue;
...
import com.example.project.module.system.framework.sms.core.client.dto.SmsReceiveRespDTO;
import com.example.project.module.system.framework.sms.core.client.dto.SmsSendRespDTO;
import com.example.project.module.system.framework.sms.core.client.dto.SmsTemplateRespDTO;
import com.example.project.module.system.framework.sms.core.enums.SmsTemplateAuditStatusEnum;
import com.example.project.module.system.framework.sms.core.property.SmsChannelProperties;
...
public class AliyunSmsClient extends AbstractSmsClient {
    ...
    private static final String URL = "https://example.invalid/resource";
    ...
    public SmsSendRespDTO sendSms(Long sendLogId, String mobile, String apiTemplateId,
        ...
        // 1. 执行请求
        // 参考链接 https://example.invalid/resource
    ...
    public List<SmsReceiveRespDTO> parseSmsReceiveStatus(String text) {
        ...
        // 字段参考 https://example.invalid/resource
     ...
     * 请求阿里云短信
     *
     * @see <a href="https://example.invalid/resource">V3 版本请求体&签名机制</>
