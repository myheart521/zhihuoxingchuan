package com.example.project.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode USER_AUTHORITY_COMMENT = new ErrorCode(1_002_003_011, "审核意见不能为空");
    ErrorCode UPDATE_USER_INFO_FAIL = new ErrorCode(1_002_003_013, "您已经是审核用户了");

    ErrorCode UPDATE_MANAGE_FAIL = new ErrorCode(1_002_003_012, "修改失败，只有帅比admin才能修改");
