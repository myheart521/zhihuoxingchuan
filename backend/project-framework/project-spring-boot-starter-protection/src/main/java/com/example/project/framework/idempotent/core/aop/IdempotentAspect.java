package com.example.project.framework.idempotent.core.aop;
...
import com.example.project.framework.idempotent.core.annotation.Idempotent;
...
public class IdempotentAspect {
    ...
    public Object aroundPointCut(ProceedingJoinPoint joinPoint, Idempotent idempotent) throws Throwable {
        ...
        try {
            ...
            // 3. 异常时，删除 Key
            // 参考美团 GTIS 思路：https://example.invalid/resource
