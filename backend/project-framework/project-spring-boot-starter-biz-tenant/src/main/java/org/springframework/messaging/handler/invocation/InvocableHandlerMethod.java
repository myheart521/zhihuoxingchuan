...
import static com.example.project.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
        ...
        public Class<?> getParameterType() {
            ...
            if (this.returnType != null) {
                try {
                    ...
                    // 处理类型转换错误
                    System.err.println("无法将 returnType 转换为 Class 对象：" + e.getMessage());
                    // 抛出异常或返回一个默认值
                    throw e;
                }
            } else {
                // 处理 returnType 为 null 的情况
                System.err.println("returnType 为 null，无法转换为 Class 对象。");
                // 抛出异常或返回一个默认值
                throw new IllegalArgumentException("returnType 为 null，无法转换为 Class 对象。");
            }
        }
