package com.example.project.framework.mq.redis.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.example.project.framework.common.enums.DocumentEnum;
import com.example.project.framework.mq.redis.core.RedisMQTemplate;
import com.example.project.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.example.project.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.example.project.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class ProjectRedisMQConsumerAutoConfiguration {
     ...
     *
     * 基础知识：<a href="https://example.invalid/resource">Redis Stream 的 xreadgroup 命令</a>
     */
