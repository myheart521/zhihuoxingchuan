...
@Component
public class RevolutionWSMessageListener implements WebSocketMessageListener<SendMessage> {
    @Resource
    ...
    public void onMessage(WebSocketSession session, SendMessage message) {
        ...
        chatMessagesGroupDO.setReceiverGroup(BlogCommunicationTypeEnum.REVOLUTION.getStatus())
